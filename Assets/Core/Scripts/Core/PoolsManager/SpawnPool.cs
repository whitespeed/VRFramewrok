...
namespace Framework
{
    public sealed class SpawnPool : MonoBehaviour, IList<Transform>
    {
        ...
        /// Instantiate() that takes position and rotation. The return TimeCodecType is different 
        ...
        /// that takes position and rotation. The return TimeCodecType is different though.
        /// </summary>
